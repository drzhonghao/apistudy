...
public class MockTable {
	static class MockMemKey extends Key {
		...
		public boolean equals(Object other) {
			return ((other instanceof MockTable.MockMemKey) && (super.equals(other))) && ((count) == (((MockTable.MockMemKey) (other)).count));
		}
		...
		public int compareTo(Key o) {
			...
			if (o instanceof MockTable.MockMemKey) {
				MockTable.MockMemKey other = ((MockTable.MockMemKey) (o));
	...
	synchronized void addMutation(Mutation m) {
		...
		for (ColumnUpdate u : m.getUpdates()) {
			...
			table.put(new MockTable.MockMemKey(key, mutationCount), new Value(u.getValue()));
		}
	}
