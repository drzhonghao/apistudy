...
import org.apache.karaf.service.command.ObjectClassCompleter;
...
public class ListServices implements Action {
	...
	public Object execute() throws Exception {
		...
		Collections.sort(serviceRefs, new ListServices.ServiceClassComparator());
	...
	private void listNames() {
		Map<String, Integer> serviceNames = ListServices.getServiceNamesMap(bundleContext);
