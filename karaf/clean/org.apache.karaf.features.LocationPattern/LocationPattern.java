...
public class LocationPattern {
    ...
    public LocationPattern(String uri) throws IllegalArgumentException, MalformedURLException {
        if (uri == null) {
     ...
     */
    public boolean matches(String otherUri) throws MalformedURLException {
        if (otherUri == null) {
            return false;
        }
