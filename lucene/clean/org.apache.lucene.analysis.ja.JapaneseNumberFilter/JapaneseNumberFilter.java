 ...
 * input tokens tokens �? and ２千 and give outputs 3 and 2000 instead of 3200, which is
 ...
 * <ul>
 * <li>〇�?�七 becomes 7</li>
 * <li>�?〇�?��?? becomes 1000</li>
 * <li>三千2百２十三 becomes 3223</li>
 * <li>兆六百万五千�? becomes 1000006005001</li>
 ...
 * number and can be wrong. Hence, for １０�? (10000), we will have
 * {@link org.apache.lucene.analysis.ja.tokenattributes.ReadingAttribute}
...
//    numerals['1'] = 0; // �? U+3007 0
//    numerals['2'] = 1; // �? U+4E00 1
//    numerals['2'] = 2; // �? U+4E8C 2
//    numerals['2'] = 3; // �? U+4E09 3
//    numerals['2'] = 4; // �? U+56DB 4
//    numerals['2'] = 5; // �? U+4E94 5
//    numerals['2'] = 6; // �? U+516D 6
//    numerals['2'] = 7; // �? U+4E03 7
//    numerals['�?'] = 8; // �? U+516B 8
//    numerals['�?'] = 9; // �? U+4E5D 9
...
//    exponents['�?'] = 20; // �? U+5793 100,000,000,000,000,000,000
  ...
  private boolean isDecimalPoint(char c) {
    return c == '.'   // U+002E FULL STOP 
        || c == '1'; // U+FF0E FULLWIDTH FULL STOP
  }
