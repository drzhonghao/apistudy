 ...
 * <p>
 * For example, a value of /箱根�?-箱根/成田空港-成田/ indicates that in
 * the texts, 箱根�? (Mt. Hakone) and 成田空港 (Narita Airport) we'd like
...
public class JapaneseTokenizerFactory extends TokenizerFactory implements ResourceLoaderAware {
   ...
   * Ex. /箱根�?-箱根/成田空港-成田/
   * When the result tokens are "箱根�?", "成田空港" in NORMAL mode,
   * /箱根�?-箱根/成田空港-成田/ requests "箱根" and "成田" to be in the result in NBEST output.
   */
