...
class GeoWideSouthRectangle {
	...
	protected final GeoWideSouthRectangle.EitherBound eitherBound;
	...
	public GeoWideSouthRectangle(final PlanetModel planetModel, final double topLat, final double leftLon, double rightLon) {
		...
		this.eitherBound = new GeoWideSouthRectangle.EitherBound();
		this.edgePoints = new GeoPoint[]{ planetModel.SOUTH_POLE };
	}

	public GeoWideSouthRectangle(final PlanetModel planetModel, final InputStream inputStream) throws IOException {
	...
	public boolean intersects(final GeoShape geoShape) {
		return ((geoShape.intersects(topPlane, topPlanePoints, eitherBound)) || (geoShape.intersects(leftPlane, leftPlanePoints, topPlane))) || (geoShape.intersects(rightPlane, rightPlanePoints, topPlane));
	}
