...
public final class SpanOrQuery extends SpanQuery {
	...
	private final void addClause(SpanQuery clause) {
		if ((field) == null) {
			...
			if (((clause.getField()) != null) && (!(clause.getField().equals(field)))) {
	...
	public SpanWeight createWeight(IndexSearcher searcher, boolean needsScores, float boost) throws IOException {
		...
		return new SpanOrQuery.SpanOrWeight(searcher, (needsScores ? SpanQuery.getTermContexts(subWeights) : null), subWeights, boost);
	}
	...
	public class SpanOrWeight extends SpanWeight {
		...
		@Override
		public Spans getSpans(final LeafReaderContext context, SpanWeight.Postings requiredPostings) throws IOException {
